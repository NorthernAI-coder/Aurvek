...
title: Features that Aurvek does not currently support
...
Aurvek is a web-based platform accessed through a browser. There are several features commonly found in other AI platforms that Aurvek does not currently offer, including native mobile apps, offline access, and a self-hosted option for end users.
